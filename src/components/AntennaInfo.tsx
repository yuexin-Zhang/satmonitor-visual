        ...
        <div className="flex-1 min-h-0 flex flex-col overflow-y-auto">
          <div className="pt-4 border-t border-slate-800 flex flex-col">
            ...
            <div className="space-y-2">
              ...
              {/* 强度预警 */}
              <div className="relative overflow-hidden rounded-md border border-sky-500/20 bg-sky-950/10 mb-4">
              ...
              {/* 折线图 */}
              <div className="shrink-0 flex justify-between items-center text-[clamp(11px,0.9vw,15px)]">
