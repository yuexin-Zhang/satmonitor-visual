    ...
    <div className="glass-card h-full flex flex-col">
      ...
      <div className="panel-content flex-1 flex flex-col gap-1.5 justify-start overflow-y-auto">
        <div className="flex items-center gap-2">
            ...
            <span className="text-[clamp(10px,0.85vw,14px)] text-emerald-400 font-medium">{todayAlert ? '今日有预警' : '今日无预警'}</span>
        </div>
        ...
        <div className="flex items-center gap-2 text-[clamp(10px,0.85vw,14px)]">
          ...
          <span className="text-[clamp(12px,1.0vw,18px)] text-amber-400 font-mono font-bold">{yearlyCount}</span>
